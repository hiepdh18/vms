...
export class OnvifServiceMedia extends OnvifServiceBase {
  ...
  getVideoEncoderConfiguration(
    params: ConfigurationTokenParams
  ): Promise<Result> {
    let soapBody = '';
  ...
  addVideoEncoderConfiguration(
    params: ProfileAndConfigurationTokenParams
  ): Promise<Result> {
    let soapBody = '';
  ...
  setVideoEncoderConfiguration(
    params: SetVideoEncoderConfigurationParams
  ): Promise<Result> {
    let soapBody = '';
    soapBody += '<trt:SetVideoEncoderConfiguration>';
    soapBody +=
      '<trt:Configuration token = "' + params.ConfigurationToken + '"';
  ...
  setVideoSourceConfiguration(
    params: SetVideoSourceConfigurationParams
  ): Promise<Result> {
    let soapBody = '';
    ...
    if (params.Extension) {
      ...
      if (params.Extension.Rotate) {
        ...
        if (typeof params.Extension.Rotate.Degree === 'number') {
          soapBody +=
            '<tt:Degree>' + params.Extension.Rotate.Degree + '</tt:Degree>';
        }
        soapBody += '</tt:Rotate>';
      }
      if (params.Extension.Extension) {
        ...
        if (params.Extension.Extension.LensDescription) {
          ...
          if (
            typeof params.Extension.Extension.LensDescription.FocalLength ===
            'number'
          )
            soapBody +=
              ' FocalLength = "' +
              params.Extension.Extension.LensDescription.FocalLength +
              '"';
          soapBody += '>';
          soapBody += '<tt:Offset';
          if (
            typeof params.Extension.Extension.LensDescription.Offset.x ===
            'number'
          )
            soapBody +=
              ' x = "' +
              params.Extension.Extension.LensDescription.Offset.x +
              '"';
          if (
            typeof params.Extension.Extension.LensDescription.Offset.y ===
            'number'
          )
            soapBody +=
              ' y = "' +
              params.Extension.Extension.LensDescription.Offset.y +
              '"';
          soapBody += '></tt:Offset>';
          ...
          soapBody +=
            ...
            '</tt:Radius>';
          if (
            typeof params.Extension.Extension.LensDescription.Projection
              .Transmittance === 'number'
          ) {
            soapBody +=
              '<tt:Transmittance>' +
              params.Extension.Extension.LensDescription.Projection
                .Transmittance +
              '</tt:Transmittance>';
          }
          soapBody += '</tt:Projection>';
          soapBody +=
            '<tt:XFactor>' +
            params.Extension.Extension.LensDescription.XFactor +
            '</tt:XFactor>';
          soapBody += '</tt:LensDescription>';
        }
        if (params.Extension.Extension.SceneOrientation) {
          ...
          soapBody +=
            '<tt:Mode>' +
            params.Extension.Extension.SceneOrientation.Mode +
            '</tt:Mode>';
  ...
  setMetadataConfiguration(
    params: SetMetadataConfigurationParams
  ): Promise<Result> {
    let soapBody = '';
    ...
    if (params.PTZStatus) {
      ...
      soapBody +=
        '<tt:Position>' + params.PTZStatus.Position + '</tt:Position>';
      soapBody += '</tt:PTZStatus>';
    }
  ...
  setAudioSourceConfiguration(
    params: SetAudioSourceConfigurationParams
  ): Promise<Result> {
    let soapBody = '';
  ...
  setAudioEncoderConfiguration(
    params: SetAudioEncoderConfigurationParams
  ): Promise<Result> {
    let soapBody = '';
